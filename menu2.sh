...
echo -e "${B}[005]${R} ► Senarai login           ${B}[060]${R} ► Cek maklumat akaun"
echo -e "${B}[006]${R} ► Tambah masa aktif"
echo -e "${B}[007]${R} ► Padam akaun             ${C}Menu Trojan${R}"
echo -e "${B}[008]${R} ► Padam akaun expire      ${B}[061]${R} ► Membuat akaun"
...
echo -e "${B}[039]${R} ► Cek user login          ${B}[093]${R} ► Autobackup Nginx"
